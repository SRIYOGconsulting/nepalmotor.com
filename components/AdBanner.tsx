...
const AdBanner = () => {
  return (
    <section className="w-full border-y border-white/10 bg-[#090909]">
        ...
        <div className="py-8 px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col items-center lg:items-start gap-5 text-center lg:text-left flex-grow lg:mx-8">
              ...
              <Link href={'/testdrive'}
                type="button"
                className="lux-button mt-4 px-8 py-2.5 text-base font-semibold cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
              >
                Book a Test Drive
              </Link>
            </div>
            ...
            <div className="mt-6 lg:mt-0 flex flex-col items-center">
              <p className="text-sm text-neutral-400 uppercase tracking-widest">Sponsored by</p>
              <div className="mt-2">
                <Image
