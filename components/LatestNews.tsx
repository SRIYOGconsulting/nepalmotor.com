...
const LatestNews = () => {
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-4 md:px-6 lg:px-8 pb-14">
      <h2 className="text-3xl text-center md:text-4xl font-black uppercase mb-10 text-foreground">
        Latest Updates
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:items-start">
        ...
        <Link href={nepalCarNews[0].slug} className="md:row-span-2 md:col-span-1">
          {/* Image Container */}
          <div className="relative h-64 md:h-[30rem] w-full overflow-hidden rounded-xl border border-line bg-surface-2 shadow-sm shadow-black/5">
            <Image
          ...
          <div className="mt-4">
            ...
            <h3 className="text-base font-bold text-foreground hover:text-[#f4c430] transition">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
            {nepalCarNews.slice(1, 3).map((item, i) => (
              <Link href={item.slug} key={i}>
                ...
                <div className="relative h-48 w-full overflow-hidden rounded-xl border border-line bg-surface-2 shadow-sm shadow-black/5">
                  <Image
                    src={item.image}
                    alt={item.title}
                    fill
