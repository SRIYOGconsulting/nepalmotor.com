  ...
  if (!result.success) {
    return (
      <div className="space-y-3">
        ...
        <p className="text-sm text-red-500">{result.message || 'Failed to load old cars'}</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold">Old Cars</h1>
          <p className="mt-1 text-sm text-gray-500">Inventory and user submissions (sell-only and exchange).</p>
        </div>
